...
def main():
    ...
    print(f'{electric_blue}╚═══════════════════════════════════════════════════════════╝{reset}')
    print(f"{neon_green}  [1] {HEART_SYMBOL} REACTIONS...............[ALL TYPE REACT INCLUDING COMMENT REACT]  {reset}")
    print(f"{neon_yellow}  [2] {HEART_SYMBOL} COMMENTS................[ALL TYPE RC/Voting with save]   {reset}")
